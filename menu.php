        ...
        <tr>
          <td valign="top">
		    ...
		    <table width="440" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td width="440" valign="top" background="../../image/img_side/img_87.jpg">
...
<form name="fm">
	...
	<input type="hidden" name="btn_login_txt" value=<?=$btn_login_txt?>>
                      ...
                      <td width="40%" align="center" valign="middle"><b><div id="divclock" style = 'font-size:12pt'>통화시간 : 00:00:00</div></b></td>
					  <td width="60%" height="22"  align="right"><b style = 'font-size:12pt'>전화번호</b> <input style = 'font-size:12pt'type="text" id="telno" name="telno" value="" size="18">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
<!--  cti module 시작  -->
			<OBJECT style="Z-INDEX: 100; LEFT: 0px; VISIBILITY: visible; POSITION: absolute; TOP: 0px" codeBase=http://www.callnetkorea.co.kr/webphonetest/callnet.cab#version=1,0,1,0 height=0 width=0 classid=clsid:130E35D9-EC3A-43E2-871E-E3AE7837D34D name=unpbx VIEWASTEXT></OBJECT>

	<OBJECT height=0 width=0 classid=clsid:17C6A0B3-9B9D-46FC-9201-5C90702FC915 name=CnRec></OBJECT>
                    <tr>
                      <td colspan="2">
					    <table width="180" border="0" cellspacing="0" cellpadding="0" align="center">
						  ...
						  <tr>
							<td width="180">
					          <table width="180" border="0" cellspacing="0" cellpadding="0" align="right">
							    <tr>
								  <td align="right" height="30">&nbsp;<a href="#" onClick="javascript:makecall();"><img src="../../img/bua_06.gif" name="btn_makecall" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:answer();"><img src="../../img/bua_20.gif" name="btn_answer" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:disconnect();"><img src="../../img/bua_21.gif" name="btn_disconnect" border="0" align="absbottom"></a></td>
								</tr>
								<tr>
								  <td align="right" height="30">&nbsp;<a href="#" onClick="javascript:consult();"><img src="../../img/bua_07.gif" name="btn_consult" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:reconnect();"><img src="../../img/bua_10.gif" name="btn_reconnect" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:;transfer()"><img src="../../img/bua_11.gif" name="btn_transfer" border="0" align="absbottom"></a></td>
								</tr>
								<tr>
								  <td align="right" height="30">&nbsp;<input type="hidden" name="btn_break_txt" value="<?=btn_break_txt?>">
										<a href="#" onClick="javascript:breakon(1);"><img src="../../img/bua_04.gif" name="btn_breakon" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:daegi(0);"><img src="../../img/bua_08.gif" name="btn_endready" border="0" align="absbottom"></a>&nbsp;<a href="#" onClick="javascript:login();"><img src="../../img/buc_01.gif" name="btn_login" border="0" align="absbottom"></a></td>
								</tr>
								<tr>

								<td align="right" height="30">&nbsp;
								<a href="#" onClick="open_extension();"><img src="../../img/intra.jpg" name="" border="0" align="absbottom"></a>
								</td>
							...
							<td width="50">
					          <table width="50" border="0" cellspacing="0" cellpadding="0">
								<tr>
								  <td align="center">
									&nbsp;&nbsp;&nbsp;<textarea name="status" cols="21" rows="6"></textarea></td>
								</tr>
							  </table>
							</td>
						  </tr>
                          ...
                          <tr>
                            <td colspan="2"><img src="../../image/img_side/img_99.jpg" width="440" height="12"></td>
                          </tr>
                        </table>
					  </td>
                    </tr>
...
<SCRIPT language=javascript event=IncomingCall for=unpbx>
	...
	if(cid.substr(0,2) == "02"){
		if(cid.length ==10){
			cid = cid.substr(0,2)+"-"+cid.substr(2,4)+"-"+cid.substr(6,4)

		}else if(cid.length ==9){
			cid = cid.substr(0,2)+"-"+cid.substr(2,3)+"-"+cid.substr(5,4)
		}
	}else{
		if(cid.length ==10){
			cid = cid.substr(0,3)+"-"+cid.substr(3,3)+"-"+cid.substr(6,4)

		}else if(cid.length ==11){
			cid = cid.substr(0,3)+"-"+cid.substr(3,4)+"-"+cid.substr(7,4)
		}
	}
...
//document.getElementById("btn_eduon").src	="../../img/bua_40.gif";
//document.getElementById("btn_eduoff").src	="../../img/bua_41.gif";
parent.location.href("../../logout_ok.php");
//-->
</SCRIPT>
