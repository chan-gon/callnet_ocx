...
function pie()
{
	...
	this.c_array[0] = new Array(250, 94, 31);
	this.c_array[1] = new Array(253, 203, 63);
	this.c_array[2] = new Array(113, 215, 67);
	this.c_array[3] = new Array(210, 51, 51);
	this.c_array[4] = new Array(186, 231, 63);
	this.c_array[5] = new Array(171, 123, 85);
	this.c_array[6] = new Array(179, 129, 201);
	this.c_array[7] = new Array(213, 122, 81);
	this.c_array[8] = new Array(57, 181, 74);
