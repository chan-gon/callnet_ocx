...
function pie()
{
	...
	this.c_array[11] = new Array(180, 127, 175);
	this.c_array[12] = new Array(59, 87, 112);
	this.c_array[13] = new Array(11, 120, 96);
	this.c_array[14] = new Array(24, 119, 96);
	this.c_array[15] = new Array(180, 159, 144);
	this.c_array[16] = new Array(107, 88, 95);
	this.c_array[17] = new Array(164, 135, 96);
	this.c_array[18] = new Array(139, 160, 95);
	this.c_array[19] = new Array(44, 151, 80);
	this.c_array[20] = new Array(155, 136, 80);
	...
	this.render = function(canvas, title, size)
	{
		...
		size?size=size:size=cW*.3; //if no size is provided, default to 50% of the canvas width.
		r = size/2;
		sx = cW/2 - r;	//start X
		sy = cH/2 - r;	//start Y
